...
/*
 entf-sp-2.2.0.min.js
 Copyright (c) 2017 Rakuten, Inc
 Date: 2017-04-10 12:15:05
*/
(function(d){d(function(){var f=d("#notificationList"),h=d("#notificationBadge"),k=d("#notificationButton"),p=f.find(".ritNotificArea"),w=f.find(".ritNotificInfo"),x=f.find(".ritNotificError"),F=f.find(".ntfTtl"),T=f.find(".backhome"),G=d(".ntfRelativeTarget"),t=d("body"),y=d("html"),z=void 0,q=void 0,u=void 0,l=!1,H=!1,I=!1,J=!1,m=!1,A=!0,B=0,K=0,v=!1,r={},L=void 0,M=void 0;moment.lang("ja",{relativeTime:{future:"%s\u5f8c",past:"%s\u524d",s:"\u6570\u79d2",m:"1\u5206",mm:"%d\u5206",h:"1\u6642\u9593",
hh:"%d\u6642\u9593",d:"1\u65e5",dd:"%d\u65e5",M:"1\u30f6\u6708",MM:"%d\u30f6\u6708",y:"1\u5e74",yy:"%d\u5e74"},weekdays:"\u65e5\u66dc\u65e5 \u6708\u66dc\u65e5 \u706b\u66dc\u65e5 \u6c34\u66dc\u65e5 \u6728\u66dc\u65e5 \u91d1\u66dc\u65e5 \u571f\u66dc\u65e5".split(" ")});var U=function(a){a=moment(a,"YYYY-MM-DD HH:mm:ss");return 36>moment().diff(a,"hours")?a.fromNow():7>moment().diff(a,"days")?a.format("dddd"):a.format("M\u6708D\u65e5")},E=function(){d.jsonp({url:"//event.notifier.rakuten.co.jp/3.0/notification/get",
charset:"utf-8",callback:"_entf",callbackParameter:"callback",data:{last_id:B,loc_id:u},cache:!1,timeout:5E3,success:function(a,c){var b;I||"undefined"===typeof a.template||V(a.template.css);if(200===a.status.code||201===a.status.code){v||(v=!0);var e=a.notifications;b={};b.Submit_kind=l?"polling":"init";l||(l=!0,0<e.length&&$orginal("#notifDataReceiver").trigger("notifDataReceived",[e]));a.open_last_id>K&&(K=a.open_last_id,C(0));0<a.last_id&&(B=a.last_id);var n=a.badge;b.NoticeNum_badgeCount=n;var s=
f.find(".ntfArticle").length+e.length;if(0===f.find(".ntfProcess").length&&/^[0-9]{2}$/.test(a.p)){var g=parseInt(new Date/1E3);F.append('<img src="//static.event.notifier.rakuten.co.jp/ntf.gif?p='+a.p+"&t="+g+'" class="ntfProcess" width="0" height="0">')}if(0===s){b=d.tmpl(a.template.empty);N(b);m&&eventPageNotify.empty();return}0<e.length&&(W(e,a.template),m&&eventPageNotify.received(e));0<n&&(k.hasClass("opened")?O():(e=parseInt(h.text()),C(e+n)));if("init"===b.Submit_kind||0<parseInt(b.NoticeNum_badgeCount)){n=
[];for(e=0;e<a.notifications.length;e++)s={},g="non_rat_key","undefined"!==typeof a.notifications[e].rat_key&&(g=a.notifications[e].rat_key.charAt(0).toUpperCase()+a.notifications[e].rat_key.slice(1)),s.Notification_type=g,s.Notification_id=a.notifications[e].id,n.push(s),r[a.notifications[e].id]=g;D("get",b,n)}}else 400===a.status.code?(l||(l=!0),v=!1,m&&eventPageNotify.notLogin(),b=d.tmpl(a.template.login,{login_url:a.login_url}),N(b)):(P(),m&&eventPageNotify.error());if("undefined"!==typeof a.rd_open_flg&&
!0===a.rd_open_flg&&!1===J)d(window).on("load",function(){J=!0;k.trigger("click")})},error:function(a,c,b){P();m&&eventPageNotify.error()}});X()},Q=function(){A&&0<q&&(q-=1,E());0<q&&setTimeout(Q,z)},C=function(a){h.text(a);0<a?h.css("display","block"):h.css("display","none")},X=function(){f.find("abbr.ntfTime").each(function(){var a=d(this),c=a.attr("original-date");""!==c&&a.text(U(c))})},W=function(a,c){w.css("display","none");x.css("display","none");50<a.length&&(a=a.slice(a.length-50));for(var b=
0;b<a.length;b++){var e=Y(a[b],c);"undefined"!==typeof e&&null!==e&&(a[b].highlight?e.prependTo(p).find("a").bind("click",function(){Z(d(this));return!1}):e.prependTo(p).find("a").bind("click",function(){var a=d(this).attr("notification-id"),b=d(this).attr("href");if("undefined"===typeof a||"undefined"===typeof b)return!1;R(a);location.href=b;return!1}))}p.css("display","block")},g=function(a){return"function"===typeof a},R=function(a){var c="non_rat_key";"undefined"!==typeof r[a]&&(c=r[a]);var b=
{};b.Notification_type=c;b.Notification_id=a;a=[];a.push(b);D("click",{},a)},Z=function(a){var c=a.attr("notification-id"),b=a.attr("href");"undefined"!==typeof c&&"undefined"!==typeof b&&d.jsonp({url:"//event.notifier.rakuten.co.jp/3.0/notification/click",charset:"utf-8",callback:"_entf",callbackParameter:"callback",data:{id:c,locId:u},cache:!1,timeout:5E3,success:function(a,d){R(c);location.href=b},error:function(a,c,d){location.href=b}})},O=function(){d.jsonp({url:"//event.notifier.rakuten.co.jp/3.0/notification/open",
charset:"utf-8",callback:"_entf",callbackParameter:"callback",data:{last_id:B,locId:u},cache:!1,timeout:5E3,success:function(a,c){201===a.status.code&&E()},error:function(a,c,b){}})},N=function(a){x.css("display","none");p.css("display","none");w.html(a).css("display","block")},P=function(){l||(p.css("display","none"),w.css("display","none"),x.css("display","block"))},D=function(a,c,b){try{v&&(c.Action=a,c.Notifications=b,a={accountId:403,serviceId:1,pData:{pgn:"ichiba",pgl:"SP"},cpData:c},b={accId:403,
servId:1,eventType:"async",cpData:c},g(RAT.addCustomEvent)?RAT.addCustomEvent(a):g(RAT.callCustomRequest)?RAT.callCustomRequest(b):g(RAT.callCostomRequest)&&RAT.callCostomRequest("Notification",c,403,1))}catch(d){}},Y=function(a,c){var b;b=a.template_type.toString();b=100<=a.type?c.template_notification[b]:c.notification[b];return"undefined"===typeof b?null:d.tmpl(b,a)},S=function(a){var c="https:"===document.location.protocol?"https:":"http:";a="1.4626."+a;var b=encodeURIComponent("Event Notification"),
d=encodeURIComponent("Event Notification"),f=encodeURIComponent(document.referrer),g=(new Date).getTime()*Math.random();F.append('<img src="'+(c+"//anz.rd.rakuten.co.jp/p/?i="+a+"&n="+b+"&l="+d+"&r="+f+"&c="+g+"&d=sp")+'">')},V=function(a){"https:"===document.location.protocol&&(a=a.replace(/^http:/,"https:"));document.createStyleSheet?document.createStyleSheet(a):d("head").append('<link rel="stylesheet" type="text/css" href="'+a+'">');I=!0},$=function(){f.removeClass("ntfOpen");setTimeout(function(){f.hide()},
500);t.css({height:"auto","overflow-y":L});G.css({position:"absolute"});y.css({"overflow-y":M});d(window).scrollTop(0)};(function(a){z=3E4;q=2;var c=f.attr("locid");u="undefined"!==typeof c?c:"2";a()})(function(){m=-1!==d("body").find("#eventPageNotifyDataReceiver").length&&"undefined"!==typeof eventPageNotify&&g(eventPageNotify.received)&&g(eventPageNotify.empty)&&g(eventPageNotify.notLogin)&&g(eventPageNotify.error)?!0:!1;h.text("0");k.bind("click",function(){var a=d(this);L=t.css("overflow-y");
M=y.css("overflow-y");a.addClass("opened");d(window).scrollTop(0);f.show();f.css({"min-height":d(window).height()+"px"});t.css({height:f.height()+"px","overflow-y":"hidden"});G.css({position:"relative"});y.css({height:"auto","overflow-y":"auto"});f.addClass("ntfOpen");a={};a.ButtonClick_existBadge=parseInt(h.text());var c=[],b;for(b in r){var e={};e.Notification_type=r[b];e.Notification_id=b;c.push(e)}D("open",a,c);H||(H=!0,0<f.find(".ntfArticle").length?S("580257"):S("580256"));0<parseInt(h.text())&&
(C(0),O());return!1});T.bind("click",function(){k.removeClass("opened");$()});k.find("a").attr("href","#");E();setTimeout(Q,z);d(window).bind("focus",function(){A=!0}).bind("blur",function(){A=!1});d(window).bind("resize",function(){k.hasClass("opened")&&t.css({height:f.height()+"px"})})})})})(jQuery);
window.jQuery=window.$=$orginal;})(jQuery);
